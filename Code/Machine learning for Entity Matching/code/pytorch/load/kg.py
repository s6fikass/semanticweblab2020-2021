...
class KG:
    ...
    def __init__(self, relation_triples, attribute_triples):
        ...
        self.num_entities, self.num_relations, self.num_attributes = None, None, None
        self.num_relation_triples, self.num_attribute_triples = None, None
        self.num_local_relation_triples, self.num_local_attribute_triples = None, None
        ...
        print("Number of relations:", self.num_relations)
        print("Number of attributes:", self.num_attributes)
        print("Number of relation triples:", self.num_relation_triples)
        print("Number of attribute triples:", self.num_attribute_triples)
        print("Number of local relation triples:", self.num_local_relation_triples)
        print("Number of local attribute triples:", self.num_local_attribute_triples)
        print()
    ...
    def set_relations(self, relation_triples):
        ...
        self.num_entities = len(self.entities_set)
        self.num_relations = len(self.relations_set)
        self.num_relation_triples = len(self.relation_triples_set)
        self.num_local_relation_triples = len(self.local_relation_triples_set)
    ...
    def set_attributes(self, attribute_triples):
        ...
        self.num_attributes = len(self.attributes_set)

        self.entities_set |= entities
        self.entities_list = list(self.entities_set)
        self.num_entities = len(self.entities_set)

        self.num_attribute_triples = len(self.attribute_triples_set)
        self.num_local_attribute_triples = len(self.local_attribute_triples_set)
    ...
    def add_sup_relation_triples(self, sup_triples):
        ...
        self.relation_triples_list = list(self.relation_triples_set)
        self.num_relation_triples = len(self.relation_triples_list)
    ...
    def add_sup_attribute_triples(self, sup_triples):
        ...
        self.attribute_triples_list = list(self.attribute_triples_set)
        self.num_attribute_triples = len(self.attribute_triples_list)
